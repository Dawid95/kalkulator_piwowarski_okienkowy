...
namespace CppWinForm1 {
	...
	/// Summary for Sybilla
	/// </summary>
	public ref class Sybilla : public System::Windows::Forms::Form
	{
	public:
		Sybilla(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Sybilla::typeid));
			...
			this->X_button->Click += gcnew System::EventHandler(this, &Sybilla::X_button_Click);
			// 
			// top_left
			// 
			...
			this->Name = L"Sybilla";
			this->Text = L"Sybilla";
			this->Load += gcnew System::EventHandler(this, &Sybilla::Sybilla_Load);
...
#pragma endregion
	private: System::Void Sybilla_Load(System::Object^  sender, System::EventArgs^  e) {
	}
