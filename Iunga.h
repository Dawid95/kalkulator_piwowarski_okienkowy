...
namespace CppWinForm1 {
	...
	/// Summary for Iunga
	/// </summary>
	public ref class Iunga : public System::Windows::Forms::Form
	{
	public:
		Iunga(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Iunga::typeid));
			...
			this->X_button->Click += gcnew System::EventHandler(this, &Iunga::X_button_Click);
			// 
			// top_left
			// 
			...
			this->Name = L"Iunga";
			this->Text = L"Iunga";
			this->Load += gcnew System::EventHandler(this, &Iunga::Iunga_Load);
...
#pragma endregion
	private: System::Void Iunga_Load(System::Object^  sender, System::EventArgs^  e) {
	}
