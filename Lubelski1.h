...
namespace CppWinForm1 {
	...
	/// <summary>
	/// Summary for Lubelski1
	/// </summary>
	public ref class Lubelski1 : public System::Windows::Forms::Form
	{
	public:
		Lubelski1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Lubelski1::typeid));
			...
			this->X_button->Click += gcnew System::EventHandler(this, &Lubelski1::X_button_Click);
			// 
			// top_left
			// 
			...
			this->Name = L"Lubelski1";
			this->Text = L"Lubelski1";
			this->Load += gcnew System::EventHandler(this, &Lubelski1::Lubelski1_Load);
...
#pragma endregion
	private: System::Void Lubelski1_Load(System::Object^  sender, System::EventArgs^  e) {
	}
