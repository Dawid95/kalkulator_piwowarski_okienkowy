...
namespace CppWinForm1 {
	...
	/// Summary for Lomik
	/// </summary>
	public ref class Lomik : public System::Windows::Forms::Form
	{
	public:
		Lomik(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Lomik::typeid));
			...
			this->X_button->Click += gcnew System::EventHandler(this, &Lomik::X_button_Click);
			// 
			// top_left
			// 
			...
			this->Name = L"Lomik";
			this->Text = L"Lomik";
			this->Load += gcnew System::EventHandler(this, &Lomik::Lomik_Load);
...
#pragma endregion
	private: System::Void Lomik_Load(System::Object^  sender, System::EventArgs^  e) {
	}
