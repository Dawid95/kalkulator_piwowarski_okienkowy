...
namespace CppWinForm1 {
	...
	/// Summary for Marynka
	/// </summary>
	public ref class Marynka : public System::Windows::Forms::Form
	{
	public:
		Marynka(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Marynka::typeid));
			...
			this->X_button->Click += gcnew System::EventHandler(this, &Marynka::X_button_Click);
			// 
			// top_left
			// 
			...
			this->richTextBox2->Location = System::Drawing::Point(1, 58);
			...
			this->Name = L"Marynka";
			this->Text = L"Marynka";
			this->Load += gcnew System::EventHandler(this, &Marynka::Marynka_Load);
...
#pragma endregion
	private: System::Void Marynka_Load(System::Object^  sender, System::EventArgs^  e) {
	}
